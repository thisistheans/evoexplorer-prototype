...
function updateChart() {
	...
	if (counter < 26) {
		...
		barChart.data.datasets[0].data = [14];
		barChart.data.datasets[1].data = [3];
		barChart.data.datasets[2].data = [1];
		barChart.data.datasets[3].data = [2];
		barChart.update();
	}
		...
		barChart.data.datasets[0].data = [13];
		barChart.data.datasets[1].data = [2];
		barChart.data.datasets[2].data = [1];
		barChart.data.datasets[3].data = [3];
		barChart.update();
	}
		...
		barChart.data.datasets[0].data = [14];
		barChart.data.datasets[1].data = [1];
		barChart.data.datasets[2].data = [2];
		barChart.data.datasets[3].data = [4];
		barChart.update();
	}
		...
		barChart.data.datasets[0].data = [12];
		barChart.data.datasets[1].data = [3];
		barChart.data.datasets[2].data = [2];
		barChart.data.datasets[3].data = [2];
		barChart.update();
		...
		timepassed.innerHTML = "3 Years";
		barChart.data.datasets[0].data = [11];
		barChart.data.datasets[1].data = [2];
		barChart.data.datasets[2].data = [1];
		barChart.data.datasets[3].data = [4];
		barChart.update();
		...
		barChart.data.datasets[1].data = [1];
		barChart.data.datasets[2].data = [1];
		barChart.data.datasets[3].data = [5];
		barChart.update();
	}
		...
		timepassed.innerHTML = "4 Years";
		barChart.data.datasets[0].data = [8];
		barChart.data.datasets[1].data = [1];
		barChart.data.datasets[2].data = [0];
		barChart.data.datasets[3].data = [6];
		barChart.update();
	}
		...
		barChart.data.datasets[2].data = [0];
		barChart.data.datasets[3].data = [7];
		barChart.update();
	}
		...
		barChart.data.datasets[1].data = [0];
		barChart.data.datasets[2].data = [0];
		barChart.data.datasets[3].data = [9];
		barChart.update();
	}
		...
		barChart.data.datasets[1].data = [0];
		barChart.data.datasets[2].data = [0];
		barChart.data.datasets[3].data = [10];
		barChart.update();
	}
		...
		barChart.data.datasets[1].data = [0];
		barChart.data.datasets[2].data = [0];
		barChart.data.datasets[3].data = [12];
		barChart.update();
	}
		...
		barChart.data.datasets[1].data = [0];
		barChart.data.datasets[2].data = [0];
		barChart.data.datasets[3].data = [14];
		barChart.update();
	}
		...
		barChart.data.datasets[1].data = [0];
		barChart.data.datasets[2].data = [0];
		barChart.data.datasets[3].data = [15];
		barChart.update();
	}
		...
		barChart.data.datasets[1].data = [0];
		barChart.data.datasets[2].data = [0];
		barChart.data.datasets[3].data = [16];
		barChart.update();
	}
		...
		barChart.data.datasets[1].data = [0];
		barChart.data.datasets[2].data = [0];
		barChart.data.datasets[3].data = [17];
		barChart.update();
	}
		...
		barChart.data.datasets[1].data = [0];
		barChart.data.datasets[2].data = [0];
		barChart.data.datasets[3].data = [19];
		barChart.update();
	}
		...
		barChart.data.datasets[1].data = [0];
		barChart.data.datasets[2].data = [0];
		barChart.data.datasets[3].data = [20];
		barChart.update();
	}
}
...
var anim = {
	...
	path: 'http://annietseng.co/prototype/natural-selection/case2/3-experiment/js/CaseStudy2_popA.json' // the path to the animation json
	}
